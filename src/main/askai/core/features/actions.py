...
class Actions(metaclass=Singleton):
    ...
    def check_output(self, question: str) -> str:
        """
        Name: 'check_output'
        Description: Use this tool to analyze outputs generated by previous tool invocations or any textual content. It's designed to evaluate data, verify the presence of files and folders, and conduct text analysis.
        Usage: `check_output(question)`
          input `question`: The query regarding the output. Please avoid providing terminal commands for this input.
        """
