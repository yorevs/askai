...
load_image_chain = TransformChain(
    input_variables=["image_path", "parser_guides"], output_variables=["image"], transform=load_image
)
...
def get_image_informations(image_path: str) -> dict:
    ...
    return vision_chain.invoke(
        {"image_path": f"{image_path}", "parser_guides": parser.get_format_instructions(), "prompt": vision_prompt}
    )
